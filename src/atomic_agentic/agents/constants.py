...
# =============================================================================
# Used by:
# - agents/base.py: default Agent role prompt when no role_prompt is provided.
#
# Keep this in agents rather than core because it is Agent runtime behavior, not
# an AtomicInvokable / ParamSpec primitive.
...
# - ToolAgent-specific prompt templates below
#

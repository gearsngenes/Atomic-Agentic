...
class BasicAgent(AtomicInvokable):
    ...
    def _split_inputs(
        ...
        This method assumes ``filter_inputs(...)`` has already run, including
        default injection. It splits already-resolved inputs into the pre and
        post-passthrough buckets.
